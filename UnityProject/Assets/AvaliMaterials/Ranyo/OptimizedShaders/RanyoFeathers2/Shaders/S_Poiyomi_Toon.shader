Shader "Hidden/Locked/.poiyomi/• Poiyomi Toon •/RanyoFeathers2-RanyoFeathers2"
{
    Properties
    {
...
#define PROP_EMISSIVEBLINK_MAX 1.2
#define PROP_EMISSIVEBLINK_VELOCITY 0.25
#define PROP_EMISSIONBLINKINGOFFSET -0.2
