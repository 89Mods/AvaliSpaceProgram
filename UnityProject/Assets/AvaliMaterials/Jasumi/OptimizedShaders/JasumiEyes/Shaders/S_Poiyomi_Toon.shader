Shader "Hidden/Locked/.poiyomi/• Poiyomi Toon •/JasumiEyes-JasumiEyes"
{
    Properties
    {
...
#define PROP_BRDFMETALLIC 0.178
#define PROP_BRDFGLOSSINESS 0.819
...
#define PROP_EMISSIONSTRENGTH 0.75
